...
public interface AirbnbMapper {
    ...
    @Insert({
        ...
        "#{dealStatus,jdbcType=INTEGER}, #{pictureCount,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, room_id, room_name, room_url, landlord_id, price, deal_status, picture_count, ",
